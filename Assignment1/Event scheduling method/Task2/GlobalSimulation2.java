...
public class GlobalSimulation2{
	...
	public static final int ARRIVAL = 1, READY = 2, DELAY=3, MEASURE = 4; // The events, add or remove if needed!
	public static double time = 0; // The global time variable
	public static EventListClass2 eventList = new EventListClass2(); // The event list used in the program
